...
const Intro2 = ({ onNext }) => {
  ...
  const fullText =
    "ยินดีต้อนรับสู่ท้องทะเลของพวกเรา ในขณะนี้ท่านกำลังเป็นนักดำน้ำที่กำลังจมลึกใต้ท้องทะเลอันกว่างใหญ่ หน้าที่ของท่านคือการสำรวจไปในซากปรักหักพัง และแนวปะการังหลากสี เพื่อค้นพบสิ่งมีชีวิตมากมาย โปรดเลือกการเดินทางของท่าน";
